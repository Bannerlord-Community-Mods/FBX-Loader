...
namespace Modbed
{
    public class CaptureTheBannerLordVM : ViewModel
    {
        static CaptureTheBannerLordParams lastParams = CaptureTheBannerLordParams.createDefault();
        ...
        private void StartCaptureTheBannerLord() {
            ...
            MBGameManager.StartNewGame(new CaptureTheBannerLordGameManager(p));
        }
