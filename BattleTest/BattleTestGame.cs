...
namespace Modbed
{
    public class BattleTestGame : TaleWorlds.Core.GameType
    {
        private int _stepNo;

        public static BattleTestGame Current
        {
            get
            {
                return Game.Current.GameType as BattleTestGame;
            }
        }

        public BattleTestGame()
        {
        }
        ...
        private void AddGameTexts()
        {
            ...
            // this.CurrentGame.GameTextManager.LoadGameTexts(BasePath.Name + "Modules/BattleTest/ModuleData/module_strings.xml");
        }
    }

    class BattleTestSkillList : SkillList
    {
        internal BattleTestSkillList()
        {
        }
